# Technical Architecture Guide: NutriPlan Microservice Sandbox (`ms-sandbox`)

Welcome to the **NutriPlan Pro Backend Architecture Guide** for the `ms-sandbox` microservice. This document provides a deep dive into the architecture, design patterns, and engineering choices that shape this codebase. It is designed to get any senior engineer or AI agent up to speed on the system's inner workings.
